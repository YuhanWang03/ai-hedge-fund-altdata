...
**Scheduler** — nineteen cron jobs covering screening, anomaly detection, supply-chain expansion, institutional 13F tracking, weekly backfills, daily ETF holdings ingestion, earnings reminders, post-release earnings summaries, portfolio risk snapshot, **positions snapshot (silent backend, ⑨b)**, portfolio weekly recap, SEC 8-K scanner, SEC Form 4 scanner, macro daily snapshot, macro release scanner, macro Initial Claims, macro weekly recap, P2 daily digest, and archive sweep. Each job is process-isolated; one crashing cannot poison the others.
